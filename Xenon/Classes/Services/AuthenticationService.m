...
-(void)sendAuthResponse
{
    ...
    else if([UNAME isEqualToString:@"sgerson"] && [PWD isEqualToString:@"ind"])
    {
        if(self.delegate && [self.delegate respondsToSelector:@selector(signInDidPass)])
        {
            [self.delegate signInDidPass];
    ...
    else if([UNAME isEqualToString:@"eclower"] && [PWD isEqualToString:@"axc"])
    {
        if(self.delegate && [self.delegate respondsToSelector:@selector(signInDidPass)])
        {
            [self.delegate signInDidPass];
    ...
    else if([UNAME isEqualToString:@"csperry"] && [PWD isEqualToString:@"ikg"])
    {
        if(self.delegate && [self.delegate respondsToSelector:@selector(signInDidPass)])
        {
            [self.delegate signInDidPass];
    ...
    else if([UNAME isEqualToString:@"djsmith"] && [PWD isEqualToString:@"pkc"])
    {
        if(self.delegate && [self.delegate respondsToSelector:@selector(signInDidPass)])
        {
            [self.delegate signInDidPass];
    ...
    else if([UNAME isEqualToString:@"khendrix"] && [PWD isEqualToString:@"fin"])
    {
        if(self.delegate && [self.delegate respondsToSelector:@selector(signInDidPass)])
        {
            [self.delegate signInDidPass];
    ...
    else if([UNAME isEqualToString:@"deubanks"] && [PWD isEqualToString:@"cio"])
    {
        if(self.delegate && [self.delegate respondsToSelector:@selector(signInDidPass)])
        {
            [self.delegate signInDidPass];
